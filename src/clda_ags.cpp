...
List clda_ags(
  ...
  cout << endl << endl;
  if (verbose > 1){
    cout << "clda-ags (c++): Number of saved samples - "
         << valid_samples << endl;
  }
  // Calculates the document word indices

  if (verbose > 0){
    cout << "clda-ags (c++): Initializes variables and count statistics....";
  }
  ...
  if (verbose > 1){
    cout << "clda-ags (c++): Number of collections: " << num_collections << endl;
    cout << "clda-ags (c++): Number of docs: " << num_docs << endl;
    cout << "clda-ags (c++): Number of total words: " << num_words << endl;
    cout << "clda-ags (c++): Number of test words: " << num_test_words << endl;
    cout << "clda-ags (c++): Number of topics: " << num_topics << endl;
    cout << "clda-ags (c++): Vocabulary size: " << vocab_size << endl;
  ...
  if (verbose > 0){
    cout << "clda-ags (c++): Metropolis within Gibbs sampling..." << endl << endl;
  }
  ...
  for (iter = 0; iter < max_iter; iter++) { // for each Gibbs iteration
    ...
    if (verbose > 1) {
      cout << "clda-ags (c++): gibbs iter# " << iter + 1;
    }
  ...
  if (verbose > 0){
    cout << endl;
    cout << "clda-ags (c++): Completed sampling." << endl;
  }
